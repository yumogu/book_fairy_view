<template>
  <main>
    ...
    <div class="btn">{{type === 1 ? '登录' : '注册'}}</div>
    <div>注册成功</div>
    <div class="regist" @click="changeFn(type)">{{type === 1 ? '注册' : '已有账号？立即登录'}}</div>
  </main>
</template>
<script>
export default {
